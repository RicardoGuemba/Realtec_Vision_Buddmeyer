...
def get_source_dir():
    ...
    if hasattr(sys, '_MEIPASS'):
        ...
        # Procura o diretório realtec_vision_buddmeyer
        if (current_file.parent.parent / "models").exists():
            source_dir = current_file.parent.parent
        elif (current_file.parent.parent.parent / "realtec_vision_buddmeyer").exists():
            source_dir = current_file.parent.parent.parent / "realtec_vision_buddmeyer"
        else:
...
def copy_project_files(source_dir, dest_dir):
    ...
    project_name = "realtec_vision_buddmeyer"
    ...
    if not source_project.exists():
        ...
        possible_paths = [
            source_dir,
            source_dir / "realtec_vision_buddmeyer",
            Path(__file__).parent.parent,
            Path.cwd() / "realtec_vision_buddmeyer",
        ]
...
def verify_installation(venv_python, project_dir):
    ...
    # Verifica modelos
    models_dir = project_dir / "realtec_vision_buddmeyer" / "models"
    ...
    # Verifica vídeos
    videos_dir = project_dir / "realtec_vision_buddmeyer" / "videos"
...
def main():
    ...
    # Instala dependências
    requirements_file = install_dir / "realtec_vision_buddmeyer" / "requirements.txt"
