...
# -*- coding: utf-8 -*-
"""
Instalador do Realtec Vision Buddmeyer v2.0
...
def main():
    ...
    print_header("REALTEC VISION BUDDMEYER v2.0 - INSTALADOR")
    ...
    if hasattr(sys, '_MEIPASS'):
        ...
        source_dir = Path(sys._MEIPASS) / "realtec_vision_buddmeyer"
    else:
    ...
    if not source_dir.exists():
        ...
        if (current_dir / "realtec_vision_buddmeyer").exists():
            source_dir = current_dir / "realtec_vision_buddmeyer"
        elif (current_dir.parent / "realtec_vision_buddmeyer").exists():
            source_dir = current_dir.parent / "realtec_vision_buddmeyer"
        else:
    ...
    # Copia todo o diretório realtec_vision_buddmeyer
    dest_dir = install_dir / "realtec_vision_buddmeyer"
    if dest_dir.exists():
