# Documentação — Buddmeyer Vision System v2.0
...
| **[PICK_PLACE_EXPEDICAO.md](PICK_PLACE_EXPEDICAO.md)** | Operador/Integrador | Fluxo pick-and-place sem robô conectado |
| **[TAG_CONTRACT.md](TAG_CONTRACT.md)** | Integrador/CLP | Contrato de TAGs PC ↔ CLP (EtherNet-IP) |
| **[OPORTUNIDADES_DE_MELHORIA.md](OPORTUNIDADES_DE_MELHORIA.md)** | Desenvolvimento | Backlog de melhorias priorizadas |
