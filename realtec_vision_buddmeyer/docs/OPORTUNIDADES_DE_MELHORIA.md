...
**Executar testes:** `python -m pytest realtec_vision_buddmeyer/tests/unit -v`
...
- Testes unitários: `realtec_vision_buddmeyer/tests/unit/`
- Documentação: `realtec_vision_buddmeyer/docs/`
- Contrato de TAGs: `realtec_vision_buddmeyer/docs/TAG_CONTRACT.md`
