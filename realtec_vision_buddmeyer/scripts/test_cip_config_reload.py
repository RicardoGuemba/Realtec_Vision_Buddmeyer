...
Como executar (a partir da pasta do projeto, ex.: C:\\Realtec_Vision_Buddmeyer):
  python realtec_vision_buddmeyer/scripts/test_cip_config_reload.py

Ou, a partir da pasta realtec_vision_buddmeyer:
...
# Garante que o módulo da aplicação (realtec_vision_buddmeyer) está no path
