...
def build_installer():
    ...
    project_temp = temp_data_dir / "buddmeyer_vision_v2"
    ...
    if models_temp.exists():
        add_data_args.append(f"{models_temp};buddmeyer_vision_v2/models")
    
    # Adiciona vídeos
    if videos_temp.exists():
        add_data_args.append(f"{videos_temp};buddmeyer_vision_v2/videos")
    
    # Adiciona projeto
    add_data_args.append(f"{project_temp};buddmeyer_vision_v2")
